当前日期${currentDate}。<#if summary??>策略ID:${summary.strategy.strategyId}，期权策略Code:${summary.strategy.strategyCode}，当前期权策略是：${summary.strategy.getOptionsStrategy().getName() }。</#if>
